...
const Hero = () => (
    // <div>Hero</div>
    <section id="home" className={`place-content-center flex sm:relative `}>
          <img src={panel} alt="logo" className="sm:flex hidden w-[2500px] h-[529px]" />
    <div className="sm:absolute bg-black/50 box-content  h-[450px] w-[500px] -bottom-80 left-20">
